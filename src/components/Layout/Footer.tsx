...
const Footer: React.FC = () => {
  const socialLinks = [
    { icon: FiGithub, href: 'https://github.com/Govind799', label: 'GitHub' },
    { icon: FiLinkedin, href: 'https://www.linkedin.com/in/govind-mandal-4938a125a/', label: 'LinkedIn' },
    { icon: FiMail, href: 'mailto:govind1192001@gmail.com', label: 'Email' },
  ];
    ...
    <footer className="relative bg-[#0f0c29] text-white border-t border-white/10 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          >
            <h3 className="text-2xl font-bold font-poppins mb-2 bg-gradient-to-r from-purple-400 via-pink-500 to-yellow-400 bg-clip-text text-transparent">
              Govind Mandal
            </h3>
            {/* <p className="text-white/70">Building exceptional digital experiences</p> */}
          </motion.div>
          ...
          >
            ...
            <p className="text-sm text-white/60">
              © {new Date().getFullYear()} Govind Mandal. All rights reserved.
            </p>
          </motion.div>
        </div>
