...
import profileImg from "@/assets/Govind.png";
  ...
  return (
    <section className="relative min-h-screen bg-[#0f0c29] overflow-hidden text-white flex flex-col lg:block">
      ...
      <div className="relative z-20 flex flex-col items-center text-center lg:text-left lg:items-start lg:absolute lg:left-16 lg:top-1/3 mt-20 lg:mt-0 px-6">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-teal-300">
          Govind Mandal
        </h1>
      ...
      <div className="flex lg:absolute lg:left-16 lg:bottom-12 mt-16 lg:mt-0 flex-row lg:flex-col gap-4 lg:space-y-6 z-20 justify-center mb-4">
        ...
        <a href="https://www.linkedin.com/in/govind-mandal799/" className="w-11 h-11 flex items-center justify-center bg-white rounded-full text-black" target="_blank">
          <FiLinkedin />
        </a>
        <a href="https://github.com/Govind799" className="w-11 h-11 flex items-center justify-center bg-white rounded-full text-black" target="_blank">
          <FiGithub />
        </a>
        <a href="https://leetcode.com/u/govindmandal/" className="w-11 h-11 flex items-center justify-center bg-white rounded-full text-black" target="_blank">
          <FiCode />
        </a>
        <a href="mailto:govind1192001@gmail.com" className="w-11 h-11 flex items-center justify-center bg-white rounded-full text-black" target="_blank">
          <FiMail />
        </a>
      </div>
    </section>
